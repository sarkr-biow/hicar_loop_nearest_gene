...
A re-analysis of published HiCAR chromatin interaction data from GM12878 cells, asking a simple
question: when two regions of DNA physically contact each other, does the contact usually involve
